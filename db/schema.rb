...
ActiveRecord::Schema.define(version: 20170707021957) do
  ...
  create_table "syndications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["syndicatable_type", "syndicatable_id"], name: "index_syndications_on_syndicatable_type_and_syndicatable_id"
  end
